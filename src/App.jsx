...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-full px-4 sm:px-6 lg:px-10 py-8 flex flex-col items-center justify-center font-sans overflow-x-hidden relative bg-[#050505]">
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <header className="mb-10 text-center flex flex-col items-center w-full max-w-3xl">
          ...
          <motion.h1 
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight mb-2 leading-tight bg-clip-text text-transparent bg-[length:200%_auto]"
            animate={{
              backgroundImage: [
        ...
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="w-full max-w-5xl grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-10"
        >
          {platforms.map((p) => (
            <motion.button
              key={p.id}
        ...
        {/* INPUT AREA */}
        <motion.div layout className="w-full max-w-4xl mb-8 relative z-20">
        ...
        <footer className="mt-16 text-center opacity-30 hover:opacity-100 transition-opacity pb-8">
          <p className="text-[10px] text-white font-mono tracking-[0.2em] mb-2">
            © 2026 Andri-land Downloader. All rights reserved.
          </p>
          <div className="flex items-center justify-center gap-2 text-[9px] text-white">
            <span>Powered by Andri-land</span>
          </div>
        </footer>
      </div>
    </div>
